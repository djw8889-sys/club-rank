...
export function registerClubRoutes(app: Express) {
  ...
  app.get(
    ...
    async (req: any, res: Response) => {
      try {
        ...
        console.error("❌ [Route] 내 클럽 목록 조회 오류:", error.message);
        res.status(500).json({
          error: "클럽 데이터를 불러오는 중 오류가 발생했습니다.",
  ...
  app.post(
    ...
    async (req: any, res: Response) => {
      try {
        ...
        console.error("❌ [Route] 클럽 생성 오류:", error.message);
        res.status(500).json({
          error: "클럽 생성에 실패했습니다.",
          details: error.message,
        });
  ...
  app.get("/api/clubs/search", async (req: Request, res: Response) => {
    try {
      ...
      console.error("❌ [Route] 클럽 검색 오류:", error.message);
      res.status(500).json({
        error: "클럽 검색에 실패했습니다.",
        details: error.message,
      });
  ...
  app.post(
    ...
    async (req: any, res: Response) => {
      try {
        ...
        console.error("❌ [Route] 클럽 가입 오류:", error.message);
        res.status(500).json({
          error: "클럽 가입에 실패했습니다.",
          details: error.message,
        });
  ...
  app.post(
    ...
    async (req: any, res: Response) => {
      try {
        ...
        console.error("❌ [Route] 클럽 탈퇴 오류:", error.message);
        res.status(500).json({
          error: "클럽 탈퇴에 실패했습니다.",
          details: error.message,
        });
